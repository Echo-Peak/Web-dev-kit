...
export default class ProjectController{
  ...
  this.form = {
      ...
      enums:{
        type:[
      {type:'client' ,title:'Client-side' , img:'../../../res/x256/angular.png'},
      {type:'server' ,title:'Server-side' , img:'../../../res/x256/nodejs.png'},
      {type:'iso' ,title:'isomorphic' , img:'../../../res/x256/isomorphic.png'}
      ]
      }
    }

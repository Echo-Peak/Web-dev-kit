...
/***/ function(module, exports, __webpack_require__) {
	...
	var _localStorageSetup = __webpack_require__(29);

	var _localStorageSetup2 = _interopRequireDefault(_localStorageSetup);

	var _statefull_store = __webpack_require__(30);

	var _statefull_store2 = _interopRequireDefault(_statefull_store);

	var _prototypeSetup = __webpack_require__(31);
	...
	var wdk = function () {
	  function wdk() {
	    ...
	    this.angularApp = (0, _angularBootstrap2.default)(this.states.get(), this.db()); //non angular dependancys
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (storeInstance, database) {
	  var app = angular.module('WDK', all).service({
	    ...
	    '$storage': (0, _$storage2.default)(database)
	...
	var modules = [_pannel.projectPannel.name, _console2._console.name, _router.Router.name, _projectCreator.projectCreator.name];
	var thirdParty = ['ngAnimate', 'ngMaterial', 'ngAria', 'ui.router'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mainController = __webpack_require__(9);
	...
	//COMPILEd
	.directive('projectList', ['$compile', '$storage', _projectList2.default]).controller('PannelController', ['$scope', '$state', _mainController2.default]).directive('projectPannelUi', _projectPannel2.default).directive('projectEdit', projectEdit);
...
/***/ function(module, exports) {
	...
	module.exports = "<div ng-controller=\"PannelController as Pannel\" class=\"project-pannel\"><header><md-content><section layout=\"row\" layout-align=\"center center\" style=\"border-right:1px solid #e0e0e0\"><md-button md-flex=\"33\" flex=\"flex\" ng-click=\"Pannel.importProject()\" class=\"md-primary\"><i style=\"padding-right:10px;\" class=\"fa fa-facebook\"></i><span>Import Project</span></md-button><md-button md-flex=\"33\" flex=\"flex\" ui-sref=\"project-creator\"><i style=\"padding-right:10px;\" class=\"fa fa-facebook\"></i><span>New Project</span></md-button></section></md-content></header><div project-list=\"\" class=\"project-list\"></div></div>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buildProject = __webpack_require__(10);

	var _buildProject2 = _interopRequireDefault(_buildProject);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } //var electron = require('electron');


	var PannelController = function PannelController($scope, $state) {
...
/***/ function(module, exports) {
	...
	module.exports = "<md-content><md-list><md-list-item ng-mouseenter=\"Pannel.edit.on(project.name ,$event)\" ng-mouseleave=\"Pannel.edit.off(project.name ,$event)\" ng-repeat=\"project in Pannel.projects track by project.name\" ng-click=\"Pannel.loadProject(project.name)\" class=\"md-3-line\"><project-edit></project-edit><img ng-src=\"{{project.icon}}\" class=\"md-avatar\"/><div layout=\"column\" class=\"md-list-item-text\"><h3>{{ project.name}}</h3><h4>{{ project.build }}</h4><p>Version {{ project.version}} , files {{ project.files}}</p><p>{{Pannel.generateDateFormat(project.lastModified)}}</p></div></md-list-item></md-list></md-content>"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _consoleUi = __webpack_require__(15);
...
/***/ function(module, exports) {
	...
	module.exports = "<div ng-controller=\"consoleController as console\" ng-show=\"false\" class=\"console-container\"><header><h4>Console</h4><div layout=\"row\" layout-align=\"space-between\"><md-button ng-click=\"console.toggle()\" class=\"md-raised md-primary md-button md-ink-ripple\">{{console.button}}</md-button><md-menu><md-button ng-click=\"$mdOpenMenu($event)\" class=\"md-raised md-primary md-fab md-mini\"><i class=\"fa fa-gear fa-2x\"></i><md-tooltip>Options</md-tooltip></md-button><md-menu-content><console-menu></console-menu></md-menu-content></md-menu></div></header><section class=\"console-inner\"></section></div>"
...
/***/ function(module, exports) {
	...
	var Router = exports.Router = angular.module('router', ['ui.router']).config(['$stateProvider', '$urlRouterProvider', function ($state, $url) {
	  console.log('ran');
	  $url.otherwise('/');
	  $state.state('home', home).state('project-creator', projectCreator);
	}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.projectCreator = undefined;

	var _controller = __webpack_require__(24);

	var _controller2 = _interopRequireDefault(_controller);

	var _description = __webpack_require__(25);

	var _description2 = _interopRequireDefault(_description);

	var _technologys = __webpack_require__(26);

	var _technologys2 = _interopRequireDefault(_technologys);

	var _buildSystem = __webpack_require__(27);

	var _buildSystem2 = _interopRequireDefault(_buildSystem);

	var _completion = __webpack_require__(28);

	var _completion2 = _interopRequireDefault(_completion);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var projectCreator = exports.projectCreator = angular.module('project-creator', []).controller('projectCreatorController', ['$scope', _controller2.default]).directive('projectDescription', _description2.default).directive('projectTechnologys', _technologys2.default).directive('projectBuildSystem', _buildSystem2.default).directive('projectCompletion', _completion2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProjectController = function () {
	  function ProjectController($scope) {
	    ...
	    this.enums = {
	      type: [{ type: 'client', title: 'Client-side', img: '../../../app/res/x256/angular.png' }, { type: 'server', title: 'Server-side', img: '../../../app/res/x256/nodejs.png' }, { type: 'iso', title: 'isomorphic', img: '../../../app/res/x256/isomorphic.png' }]
	    };
	    this.form = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  return {
	    restric: 'E',
	    template: (0, _loadTemplate2.default)('views', 'project_build_system')
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  return {
	    restric: 'E',
	    template: (0, _loadTemplate2.default)('views', 'project_completion')
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	 * Created by jfengjiang on 2015/9/4.
	 */
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(_window) {
	  ...
	  function setupNode() {
	    ...
	    if (true) {
	      try {
	        var _rb = __webpack_require__(35).randomBytes;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bluebird = __webpack_require__(39)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var tryConvertToPromise = __webpack_require__(46)(Promise, INTERNAL);
	var PromiseArray =
	    __webpack_require__(47)(Promise, INTERNAL,
	                                    tryConvertToPromise, apiRejection);
	var CapturedTrace = __webpack_require__(48)();
	var isDebugging = __webpack_require__(49)(Promise, CapturedTrace);
	 /*jshint unused:false*/
	var createContext =
	    __webpack_require__(50)(Promise, CapturedTrace, isDebugging);
	...
	__webpack_require__(55)(Promise, INTERNAL, tryConvertToPromise);
	__webpack_require__(56)(Promise, NEXT_FILTER, tryConvertToPromise);
	__webpack_require__(57)(Promise);
	__webpack_require__(58)(Promise);
	__webpack_require__(59)(Promise, PromiseArray, tryConvertToPromise, INTERNAL);
	Promise.Promise = Promise;
	__webpack_require__(60)(Promise, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL);
	__webpack_require__(61)(Promise);
	__webpack_require__(62)(Promise, apiRejection, tryConvertToPromise, createContext);
	__webpack_require__(63)(Promise, apiRejection, INTERNAL, tryConvertToPromise);
	__webpack_require__(64)(Promise);
	__webpack_require__(65)(Promise);
	__webpack_require__(66)(Promise, PromiseArray, tryConvertToPromise, apiRejection);
	__webpack_require__(67)(Promise, INTERNAL, tryConvertToPromise, apiRejection);
	__webpack_require__(68)(Promise, PromiseArray, apiRejection, tryConvertToPromise, INTERNAL);
	__webpack_require__(69)(Promise, PromiseArray);
	__webpack_require__(70)(Promise, PromiseArray, apiRejection);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var async = __webpack_require__(42);
	var Warning = __webpack_require__(45).Warning;
	var util = __webpack_require__(40);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (Promise, apiRejection, tryConvertToPromise,
	    createContext) {
	    var TypeError = __webpack_require__(45).TypeError;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var util = __webpack_require__(40);
	var RangeError = __webpack_require__(45).RangeError;
	var AggregateError = __webpack_require__(45).AggregateError;
	var isArray = util.isArray;
...
/***/ function(module, exports) {
	...
	module.exports = "<md-content><div layout=\"column\"><section layout=\"row\" flex=\"60\"><div flex=\"flex\" layout-padding=\"layout-padding\"><section><h4>Select destination:</h4><div layout=\"row\"><md-input-container flex=\"50\"><label>Enter path</label><input type=\"text\"/></md-input-container></div><md-button class=\"md-primary\"> browse</md-button></section><section><h4>Github repository</h4><div layout=\"row\"><md-input-container flex=\"50\"><label>Enter repository name</label><input type=\"text\" ng-model=\"Project.models.github\"/></md-input-container></div><md-button ng-click=\"Project.createRepo()\" class=\"md-primary\">create</md-button><md-button ng-click=\"Project.clone(Project.models.github)\">clone</md-button><md-button ng-click=\"Project.checkAuth()\">link</md-button></section><section><h4>Other:</h4><md-radio-group ng-model=\"Project.stuff\"><md-checkbox>include package.json</md-checkbox><md-checkbox>include .gitignore</md-checkbox><md-checkbox>include bower.json</md-checkbox></md-radio-group></section></div><div flex=\"flex\" layout-padding=\"layout-padding\"><section><h4>Project Name:</h4><div layout=\"row\"><md-input-container flex=\"flex\"><label>enter your project name</label><input type=\"text\"/></md-input-container></div></section><section><h4>Scripts:</h4><div layout=\"row\"><md-input-container flex=\"flex\"><label>main.js</label><input type=\"text\"/></md-input-container></div></section><section><h4>Version:</h4><div layout=\"row\"><md-input-container flex=\"flex\"><label>Default V0.0.0</label><input type=\"text\"/></md-input-container></div></section><section><h4>Authours:</h4><div layout=\"row\"><md-chips ng-model=\"Project.form.models.authours\" name=\"Authours\" md-max-chips=\"10\" flex=\"flex\"><md-chip-template><strong>{{$chip}}</strong></md-chip-template></md-chips></div><md-button ng-click=\"Project.form.models.authours = []\" class=\"md-primary\"> clear</md-button></section></div></section><section layout=\"row\"><div layout=\"row\" flex=\"100\"><div ng-repeat=\"type in Project.enums.type\" flex=\"flex\" style=\"height:286px\" class=\"type-row-item\"><md-button ng-click=\"Project.step(1 ,type.type)\" layout-fill=\"layout-fill\"><h4>{{type.title}}</h4><img ng-src=\"{{type.img}}\" alt=\"\" height=\"250\" class=\"type-img\"/></md-button></div></div></section></div></md-content>"

/***/ },
/* 77 */
/***/ function(module, exports) {

	module.exports = "<md-content><h4>Technologys used in this project?</h4><div><md-checkbox ng-repeat=\"tech in main.techs\">{{::tech}}  </md-checkbox></div><section><md-button class=\"md-primary\">Next</md-button></section></md-content>"
